...
const JoinGame = (props) => {
    ...
    return <div>
        ...
        <h3 style = {{textAlign: "center"}}>Made with ❤️ by Jack He. Subscribe to my <a href = 'https://www.youtube.com/channel/UC9xFO-llZ2ontatfj9LtLxw' target = '_blank'>YouTube channel</a>. Follow me on <a href = 'https://www.instagram.com/jack_he_hd/?hl=en' target = '_blank'>Instagram</a>.</h3>
    </div>
}
